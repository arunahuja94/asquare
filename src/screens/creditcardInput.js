...
function creditcardInput(props) {
    ...
    useEffect(() => {
      ...
      Alert.alert(
        ...
        { cancelable: false }
         ...
         <TouchableOpacity style={{marginHorizontal:15}} onPress={() => {
          ...
          >
           <Icon.Ionicons color="#121212" name="checkmark-circle-outline" size={25} /> 
          </TouchableOpacity>
      ...
      props.navigation.setOptions({
        ...
        <Icon.Ionicons color="#121212" name="checkmark-circle-outline" size={30} />
         </TouchableOpacity>
        ),
      });
    }
...
//console.log("focusing", field);
 ...
 <FocusAwareStatusBar barStyle="light-content" backgroundColor="#ffc000" />
      <View style={{height:150,backgroundColor:'#FFDE03',borderBottomLeftRadius:20,borderBottomRightRadius:20,paddingLeft:20 }}>
      <ScrollView
            horizontal
          ...
          >
            <TouchableOpacity
              ...
              style={[cardType== 1?styles.cardTypeSelected:styles.cardType,{borderColor: cardType== 1? 'red':'black'}]}
            >
            <Icon.Ionicons style={styles.cardTypeIcon} name="card-outline" color={cardType== 1?"red":"black"} size={20} />
            <Text style={[styles.cardTypeText,{color: cardType== 1? 'red':'black'}]}>Credit Card</Text>
            </TouchableOpacity>

            
            <TouchableOpacity
            onPress={() => updatecardType(2)}
            style={[cardType== 2?styles.cardTypeSelected:styles.cardType,{borderColor: cardType== 2? 'purple':'black'}]}
            >
              <Icon.Ionicons style={styles.cardTypeIcon} name="card-outline" color={cardType== 2?"purple":"black"} size={20} />
              <Text style={[styles.cardTypeText,{color: cardType== 2? 'purple':'black'}]}>Debit Card</Text>
            </TouchableOpacity>
          </ScrollView>  
        </View>
