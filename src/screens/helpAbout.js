  ...
  return (
    <View
      ...
      <View
        style={{
         ...
         <TouchableOpacity
          ...
          onPress={() => Linking.openURL('mailto:arunahuja94@gmail.com')}>
              <View style={[styles.haListChildIcon,{backgroundColor:'#0336FF'}]}>
         <Icon.Ionicons name="mail-outline" color="#fff" size={25} /></View>
          <Text>Contact</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          onPress={() => Linking.openURL('mailto:arunahuja94@gmail.com')}>
              <View style={[styles.haListChildIcon,{backgroundColor:'#0336FF'}]}>
         <Icon.Ionicons name="bulb-outline" color="#fff" size={25} /></View>
        ...
        <TouchableOpacity
          ...
          onPress={() => Linking.openURL('mailto:arunahuja94@gmail.com')}>
              <View style={[styles.haListChildIcon,{backgroundColor:'#0336FF'}]}>
              <Icon.Ionicons name="bug-outline" color="#fff" size={25} /></View>
    ...
    <View style={styles.seperator}></View>
         ...
         <TouchableOpacity
          ...
          onPress={() => navigation.openDrawer()}>
              <View style={[styles.haListChildIcon,{backgroundColor:'#0336FF'}]}>
          <Icon.Ionicons name="help-outline" color="#fff" size={25} /></View>
          <Text>FAQ</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.openDrawer()}>
              <View style={[styles.haListChildIcon,{backgroundColor:'#0336FF'}]}>
          <Icon.Ionicons name="shield-checkmark-outline" color="#fff" size={25} /></View>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            Alert.alert(
              ...
              <View style={[styles.haListChildIcon,{backgroundColor:'#0336FF'}]}>
          <Icon.Ionicons name="trash-bin-outline" color="#fff" size={25} /></View>
